      ...
      <AnimatePresence>
        {isOpen && (
          <motion.div
            ...
            className="absolute right-0 mt-2 w-52 rounded-2xl bg-[#FAF8F5] border border-[#E2D8C7] shadow-xl z-50 p-1.5 focus:outline-none overflow-hidden"
          >
            <div className="px-2.5 py-1.5 text-[10px] font-bold text-[#8C8375] uppercase tracking-wider border-b border-[#EBE3D3] mb-1">
                ...
                >
                  <div className="flex items-center gap-2.5">
                    ...
                    <div className="text-left">
                      ...
                      <div className="text-[10px] text-[#8C8375]">{lang.name}</div>
                    </div>
                  </div>
                  {isSelected && (
                    <Check className="w-4 h-4 text-[#8C5E2D] font-bold shrink-0" />
                  )}
                </button>
              );
            })}
